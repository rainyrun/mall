...
<body>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<ul id="loginbar" class="nav navbar-nav navbar-right">
									<li><a href="http://rainyrun.top:8088/page/login">登录</a></li>
									<li><a href="http://rainyrun.top:8088/page/register">注册</a></li>
									<li><a href="http://rainyrun.top:8091/cart/cart.html">购物车</a></li>
								</ul>
							</div>
						</div>
					</div>
	...
	$(function(){
		...
		$("#searchBtn").click(function(){
			...
			location.href = 'http://rainyrun.top:8086/search.html?q=' + searchText; 
		});
		...
		var url = "http://rainyrun.top:8088/user/token/" + _ticket;
		$.get(url, function(data){
			var data = eval("("+data+")");//转换为json对象
			if(data.status == 200){
				var username = data.data.username;
				var html = '<li><a href="#">你好，' + username + '</a></li><li><a href="http://rainyrun.top:8088/user/logout">退出</a></li><li><a href="http://rainyrun.top:8091/cart/cart.html">购物车</a></li><li><a href="http://rainyrun.top:8093/order/order_list.html">我的订单</a></li>';
				$("#loginBar").html(html);
			}
		});
